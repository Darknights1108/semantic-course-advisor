...
```powershell
D:\CodingSpace\TSW\semantic-course-advisor\start-demo.cmd
```

Or run the server directly:

```powershell
& 'C:\Users\anson\.cache\codex-runtimes\codex-primary-runtime\dependencies\node\bin\node.exe' 'D:\CodingSpace\TSW\semantic-course-advisor\scripts\serve.mjs'
```
...
If Node and npm are installed globally, this also works from `D:\CodingSpace\TSW`:
...
```powershell
D:\CodingSpace\TSW\semantic-course-advisor\run-smoke-test.cmd
```
